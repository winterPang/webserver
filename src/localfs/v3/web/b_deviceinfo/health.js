; (function ($) {
	var MODULE_NAME = "b_deviceinfo.health";
    var g_jForm= null;
    ...
    function initHealthScore() {
        ...
        function getHealthFlowSuc (data) {
            //真数据 var healthData = JSON.parse(data) || "";
            //假数据
            var healthData = {"_id":"56f1ffc00445e901003c84f4","acSN":"210235A1JT1785638361","finalscore":81,"wanspeed":5,"APpercent":1,"clientspeed":5,"security":4,"wireless":5,"system":5,"Bpercent":6,"__v":0};

            updataHealthScore(healthData);
        }
        function getHealthFlowFail (argument) {
            //真值  Frame.Msg.info("连接错误");
            //假数据
            var healthData = {"_id":"56f1ffc00445e901003c84f4","acSN":"210235A1JT1785638361","finalscore":81,"wanspeed":5,"APpercent":1,"clientspeed":5,"security":4,"wireless":5,"system":5,"Bpercent":6,"__v":0};
            updataHealthScore(healthData);
        }
    ...
    function showSystem (argument) {
        Utils.Base.openDlg("b_deviceinfo.utilization", {}, {className:"modal-large"});
    }
