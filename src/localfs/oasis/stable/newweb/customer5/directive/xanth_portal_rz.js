define(['angularAMD', 'utils', 'sprintf'],
    function (app, utils) {
        ...
        var URL_TEMPLATE_FILE = sprintf('../customer5/views/%s/xanth_portal_rz.html', sLang);
            ...
            function ($timeout, $rootScope, $http, $q) {
                return {
                    ...
                    link: function ($scope, $element, $attrs, $ngModel) {                       
                        $http.get(conditionApgroupUrl+'?devSN='+$scope.sn+'&reqType=group'+'&auth=1'                           
                        ...
                        $http.get(conditionSsidUrl+'?devSN='+$scope.sn+'&reqType=ssid'+'&auth=1'                           
                            ).success(function(data){
                                var bData = [];
                                var aData = data.clientList;
                                $.each(aData,function(i,item){
