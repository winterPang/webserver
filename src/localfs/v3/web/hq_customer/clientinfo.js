 ...
 */
(function($){
    var MODULE_NAME = "hq_customer.clientinfo";
    ...
    function initUserData_Ajax(skipWhatData,meiYeShuJu,guoLvData){
        ...
        $.extend(requestDataPost,guoLvData);
            ...
            function newLXlistlistOK(data){
                ...
                {
                    //给哪个list刷数据
                    $("#OnlineVisitorList").SList("refresh",{data:data.clientList.clientInfo,total:data.clientList.count_total});
            ...
            var url=MyConfig.path+"/stamonitor/getclientlistbycondition?devSN="+FrameInfo.ACSN+"&reqType=onlineinfo"+branchReqValueReceive+authReqValueReceive;
    ...
    function _destroy()
    {
        console.log("*******商业连锁总部//宾客信息//在线宾客*******GO OUT>>>>");
