...
;(function ($) {
    ...
    var MODULE_NAME = "city_dashboard.summary";

    var g_aApp =
    {
        "SysLog":       {position: 0, bg: "",        url: "city_dashboard.Syslog"}
        ,"APs":         {position: 1, bg: "echart-height",  url: "city_dashboard.APs"}
        ,"health":      {position: 2, bg: "echart-height",  url: "city_dashboard.health"}
        ,"SSID":        {position: 1, bg: "",               url: "city_dashboard.ssid_test"}
        ,"Clients":     {position: 2, bg: "",               url: "city_dashboard.Clients"}
        ,"Usage":       {position: 3, bg: "echart-height", url: "city_dashboard.Usage"}
    };
