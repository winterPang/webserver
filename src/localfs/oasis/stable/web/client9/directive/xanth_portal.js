define(['angularAMD', 'utils', 'sprintf'],
    function (app, utils) {
        ...
        var URL_TEMPLATE_FILE = sprintf('../client9/views/%s/xanth_portal.html', sLang);

        app.directive('xanthportal', ['$timeout', '$rootScope', '$http', '$q',
            function ($timeout, $rootScope, $http, $q) {
	            ...
	            //                     }   			            
					        ...
					        //         {sortable:true,field:'clientCout5',title:$scope.clientCount_5,searcher:{}},
					        //         {sortable:true,field:'clientCout2',title:$scope.clientCount_2,searcher:{}}
					        //     ],
					        // }; 
					        ...
					        $scope.ssidoptions={
					            ...
					            columns:[
					                ...
					                {sortable:true,field:'clientCout_5',title:$scope.clientCount_5,searcher:{}},
					                {sortable:true,field:'clientCout_2',title:$scope.clientCount_2,searcher:{}}
					            ],
					        }; 
					        ...
					        //             other = "mode5G";
					        //             $scope.$broadcast('refresh#maoxian', {
					        //                 url: '/v3/stamonitor/getclientlist_bygroupandmode?devSN='+$scope.sn+'&mode='+other+'&group='+apart,
					        //             });
					        //             $scope.$broadcast("show#delog");
					        //         }else
