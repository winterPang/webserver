define(['jquery','utils','echarts','angular-ui-router','bootstrap-daterangepicker','bsTable','css!bootstrap_daterangepicker_css','css!wiresecurit5/css/style'],function($scope,Utils,echarts) {
