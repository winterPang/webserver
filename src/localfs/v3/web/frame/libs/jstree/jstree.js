 ...
 */
	...
	$.jstree.core.prototype = {
		...
		close_node : function (obj, animation) {
			...
			if(d.length) {
				...
				/********************begin****************************/
					...
					//2014.12.04
					//plugin search' bug:
					//because the time closing,after node opening,has removed all search result nodes
					/*d
					...
					d.children("ul").attr("style","display:block !important").end()
					 .removeClass("jstree-open").addClass("jstree-closed")
		...
		open_all : function (obj, animation, original_obj) {
			...
			_this = this;
			dom = this.is_closed(obj) ? dom.find('li.jstree-closed').andSelf() : dom.find('li.jstree-closed');
			dom.each(function () {
				_this.open_node(
					this,
		...
		close_all : function (obj, animation) {
			...
			dom = this.is_open(obj) ? dom.find('li.jstree-open').andSelf() : dom.find('li.jstree-open');
