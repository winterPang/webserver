 ...
 */
define(['socketio', 'utils', 'xiaobeichat',"css!newdesign/newhome/css/index"], function (socketio, Utils) {
    window.io = socketio;
    return ['$scope', '$http', '$alertService','$timeout',"$rootScope", function ($scope, $http, $alert,$timeout,$rootScope) {
