 ...
 */
;(function ($){
	var MODULE_BASE = "city_stamgrclients",
...
Date.prototype.Format = function (fmt) { //author: meizz 
    ...
    function fanHui(){
        //返回至首页面         
         Utils.Base.redirect ({np:"city_stamgrclients.m_clients"});
         return false;         
    }
    ...
    function initGrid ()
    {
        ...
        var optonlineuser = {  
            ...
            colModel: [   
                ...
                {name: "default", value:getRcText ("FRESH"), action: Fresh},
                {name: "default", value:getRcText ("KICKOUT_lixian"), enable:shiFouYiXuanZe,action:KICKOUT_renzhengOperation},
                {name: "default", value:getRcText ("KICKOUT_ALL"), action:kickOut_AllOperation}
            ]
        };
