define(['angularAMD', './frame/component/modal/lang/bs_modal', 'css!./frame/component/modal/less/index'], function (_angularAMD, _bs_modal) {
    'use strict';

    var _angularAMD2 = _interopRequireDefault(_angularAMD);

    var _bs_modal2 = _interopRequireDefault(_bs_modal);
    ...
    _angularAMD2.default.directive('bsModal', ['$rootScope', function ($rootScope) {

        var lang = _bs_modal2.default[$rootScope.lang ? $rootScope.lang : "cn"];
        // 动画时长，毫秒
        ...
        function renderModal(options, $element) {
            ...
            header.push(strfmt('<a class="close" style="display: {1}" role="button-cancel">', options.showClose ? 'inline' : 'none'), '<span>&times;</span>', '</a>', strfmt('<h4 class="modal-title">{1}</h4>', options.title), '</div>');
            var util = {
                show: function show() {
