(function($){
    var MODULE_NAME = "classroom.safenotice";
    ...
    function initUserGrid(){
        ...
        //     Utils.Base.redirect({ np: "classroom.schoolsafe"});
        // });
    ...
    function enterDetail(param){
        ...
        Utils.Base.redirect({np: 'classroom.crowddetail',position:param[0].position,time:param[0].time,detail:param[0].detail,crowdAreaMac:str});
    }
