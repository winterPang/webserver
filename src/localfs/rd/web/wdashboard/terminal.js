(function ($)
{
var MODULE_NAME = "WDashboard.terminal";
...
function drawBarChart(oInfor)
{
    ...
    //     }
    // }
    var nWidth = $("#terminal").parent().width()*0.95;
