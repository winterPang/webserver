;(function ($) {
  ...
  /*选择时间过滤条件*/
    ...
    function initPie02()
    {
        var aData = [{name: "livep.l.qq.com",value: 1},{name: "sd.cn.miaozhen.com",value: 1},
            {name: "p.tencentmind.com",value: 1}, {name: "m7.music.126.net",value: 1},
            {name: "track.appsflyer.com",value: 1},{name: "music.163.com",value: 1},{name: "mesu.apple.com",value: 1},{name: "i.l.inmobicdn.net",value: 1}];
    ...
    function initLine02()
    {
        ...
        $("#Url_chart02").echart("init", option, oTheme);
    }
    function initBar()
    {
        var option = {
        ...
        var oTheme = {};
        $("#Url_bar").echart("init", option, oTheme);
    }

    function initFlowPie()
    {
        var option = {
            height:290,
            tooltip : {
            ...
            series : [
                ...
                },
                {
                    ...
                    data:[
                        {value:335, name:'本区上行'},
                        {value:310, name:'其他区上行'}
                    ]
                }
            ]
        };
        var oTheme = {};
        $("#Flow_pie").echart("init", option, oTheme);
    }
    function ClickInput()
    {
   ...
   /* function otherTime()
    ...
    function initForm()
        ...
        var jForm = $("#city-behavior");
        $("#city_return",jForm).on("click",function()
        {
            Utils.Base.redirect ({np:"city_behavior.index"});
            return false;
        });
