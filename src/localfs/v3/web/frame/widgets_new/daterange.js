;(function($)
{
    ...
    var oDateRange = {
        ...
        {
            this.options.dateLimit =((opt.dateLimit)||this.options.dateLimit);
            this.options.minDate=((opt.minDate)||this.options.minDate);
            this.options.maxDate=((opt.maxDate)||this.options.maxDate);
