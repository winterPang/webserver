(function($) {
    ...
    function refreshSSidInfo(needsListOpt)
    {
        var formInitObj = {
            ...
            ssidName:needsListOpt.ssidInfo.ssidName,
        ...
        if(needsListOpt.pubInfo&&needsListOpt.authInfo&&needsListOpt.themeInfo)
        {
            ...
            else if(authInfo.v3flag == 0)
            {
                ...
                //定位location设置
                if (authInfo.location == "1") {
                    $("#location",jFormSSID).MCheckbox("setState",true);
                }else {
                    $("#location",jFormSSID).MCheckbox("setState",false);
                };
            }
    ...
    function  synSSID()
    {
        ...
        var synOpt = {
            type: "GEt",
            url:v2path+"/syncAc?acsn="+FrameInfo.ACSN,
            dataType: "json",
            contentType: "application/json",
            onSuccess:synSuc,
            onFailed:synFail
    ...
    function editAndAddPub(sName,autoName,needPubObj,operateDel)
    {
        ...
        if(sName == "add")
        {
            ...
            pubData.ssidName = g_SSidInfo.needsListOpt.ssidInfo.ssidName;
            // pubData.ssidId = g_SSidInfo.needsListOpt.ssidInfo.ssid;//ID
            pubData.ssidIdV3 = g_SSidInfo.needsListOpt.ssidInfo.ssid;//ID
    ...
    function editAndaddAuth(oStData,sName,autoName,operateTheme,operatePub,operateDel)
    {
        ...
        if (oStData.location === "true") {
            oStData.locationCfg = 1;
        } else {
            oStData.locationCfg = 0;
        };
    ...
    function onSubmit()
    {
        var oTempTable = {
            ...
            column:["stName","ssidName","status","cipherSuites","IDLE_CUT_FLOW",
                ...
                "auto_study_enable", "impose_auth_time","location"]
        };
