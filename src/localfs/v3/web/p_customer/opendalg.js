;(function ($)
{
    var MODULE_NAME = "p_customer.opendalg";
    var rightLean="000";
    var g_type = "";
    function getRcText (sRcId)
    {
        return Utils.Base.getRcString ("opendalg_rc", sRcId);
    }
    function initForm(){
    ...
    function initData(aType, sName, type){
        if(type=="apgroup"){
            ...
            var requestData = "&group="+valueOfapName+"&mode="+valueOfbandType;
            url=url+requestData;
        }else if(type=="ssid"){
            ...
            var requestData = "&mode="+valueOfclientMode;
            url=url+requestData;
            ...
            var requestData = "&vendor="+valueOfclientVendor;
            url=url+requestData;
        }else{
            var url='tryCatch';
        }
