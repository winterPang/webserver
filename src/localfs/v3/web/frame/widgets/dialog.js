    ...
    var Msg =
        {
            ...
            *****************************************************************************/
            ...
            pending: function(sMsg, sType, para) {
                var sId = "frame_msg_pending";

                var iFadeIntime = para && para.fadeInTime || 400;
                ...
                sType = sType || "pending";
                sMsg = "<div class='pending-box'>"+"<div class='msg-" + sType + "'></div><span>" + sMsg;+"</span></div>";
                jInfo
                    .html(sMsg)
                    .fadeIn(iFadeIntime);
                ...
                return {
                    hPending: sId,
                    close: function (iFadeOuttime) {
                        jInfo.fadeOut(iFadeOuttime);
                    },
                    change: function (sMsg) {
                        jInfo.find('span').html(sMsg||'');
                    }
                }
            }
