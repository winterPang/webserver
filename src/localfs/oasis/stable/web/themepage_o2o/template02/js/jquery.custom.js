        	...
        	if('' != content && null != content && undefined != content){
        		...
        		for (var i in content) {
        			...
        			parent.iContent.append(jq('<div class="canvas-eachItem">' +
            				  ...
            				  '<div class="canvas-imgcontent-right">' +
          				    '<div style="height:45px;margin-left:5px;">' +
          				                       '投放ss时间：<input type="text" readonly class="ui_timepicker canvas-text-35 getTxt" value="'+(undefined == content[i][1] || "-1" == content[i][1] ? "":content[i][1])+'"/>-<input type="text" readonly class="ui_timepicker canvas-text-35 getTxt" value="'+(undefined == content[i][2]  || "-1" == content[i][2]? "":content[i][2])+'"/>' +
          				    '</div>' +
          				    '<div style="height:50px;margin-left:5px;">' +
