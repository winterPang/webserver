define(["utils"], function (Utils) {
    return ['$scope', '$http', '$q', '$rootScope', '$state','$stateParams', function ($scope, $http, $q, $rootScope, $state, $stateParams) {
        ...
        $http.get("../../init/routes.json").success(function (data) {
            ...
            //已有全部appId，请求菜单信息
            $http.get("../../init/newdesign_scene_menu.json").success(function (data) {
                //if (data.retCode == 0) {
