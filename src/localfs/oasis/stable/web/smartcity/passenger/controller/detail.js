define([ "utils","echarts"], function (Utils,echarts) {
    ...
    function drawScenicBar()
    {
        ...
        //var scenicChart = echarts.init(document.getElementById("scenic_bar"));
    ...
    function drawRegionalPassengerBar()
    {
        ...
        var regionalChart = echarts.init(document.getElementById("regional_bar"));
        regionalChart.setOption(option);

        regionalChart.on('click', regionalChartClick);
        function regionalChartClick() {
            console.log("clicked");
            $state.go('^.passenger');
        }
    }
