    ...
    return ['$scope', '$http', '$window', '$alertService', '$state', function($scope, $http, $window, $) {
        ...
        $scope.$watch('permission', function(v) {
            ...
            if ($scope.permission.write == true) {
                $scope.exportState = true;
            } else if ($scope.permission.write == false) {
                //未获取到  
                $scope.exportState = false;
            } else {
        ...
        $scope.$watch('apinfo.checked', function(newVal, oldVal) {
            console.log(newVal);
            initData(newVal);
        })
        ...
        function initData(bFlag) {
            ...
            if (bFlag == 'base') {
                ...
                columns = [
                    ...
                    { searcher: {}, sortable: true, field: 'radioId', title: getRcString("LIST_HEADER_SP")[3] },
                    { searcher: {}, sortable: true, field: 'radioChannel', title: getRcString("LIST_HEADER_SP")[4] },
                    { searcher: {}, sortable: true, field: 'radioPower', title: getRcString("LIST_HEADER_SP")[5] }
                ];
            } else if (bFlag == 'link') {
                tId = "linkApList";
                columns = [{ checkbox: true },
                    ...
                    { searcher: {}, sortable: true, field: 'onlineTime', title: getRcString("LIST_HEADER_TJ")[3] },
                ...
                columns = [
                    ...
                    { searcher: {}, sortable: true, field: 'clientCount5', title: getRcString("LIST_HEADER_YH")[3] },
                    { searcher: {}, sortable: true, field: 'clientCount2', title: getRcString("LIST_HEADER_YH")[4] }
                ];
            }
