(function ($) {
  function SlickGridPager(dataView, grid, $container) {
    ...
    function constructPagerUI() {
      ...
      $settings
          .append("<span class='slick-pager-settings-expanded' style='display:none'>" + $.MyLocale.PAGR_SHOW + " <a data=0>" + $.MyLocale.PAGE_ALL + "</a><a data='-1'>" + $.MyLocale.PAGE_AUTO + "</a><a data=10>10</a></a><a data=20>20</a><a data=50>50</a></span>");
      ...
      $settings.find("a[data]").click(function (e) {
        ...
        $container.closest('.mlist').find('.slick-viewport').scrollTop(0).scroll();
    ...
    function updatePager(pagingInfo) {
      ...
      $('.data-count',$status).html(dataView.getLength());
