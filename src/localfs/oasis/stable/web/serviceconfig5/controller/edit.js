...
define(['jquery','utils','bsTable'],function($scope,Utils) {
    return ['$scope', '$http','$state','$window','$stateParams','$alertService',function($scope,$http,$state,$window,$stateParams,$alert){
        ...
        //  =========================页面初始化开始==============================
            var g_authType,g_themeType,g_authTemName,g_pageTemName,g_weixinAccountName,g_stnames,g_themeNames,g_authTemNames;
            ...
            $http({
                ...
                $scope.userData={
                    ...
                    ssidState:data.hideSSID==1?"ssid_show":"ssid_hide"
    	        } 
            ...
            function queryPubmng(stName){               
                ...
                $http({
                    ...
                    if(response.errorcode==0){        
                        var themeName=response.data.newThemeName.split("_")[0];
                        var themeType=response.data.newThemeName.split("_")[1];
                        ...
                        $scope.userData.pageSelect=themeName+getRcString("themeName").split(",")[themeType];
                        g_pageTemName=response.data.themeTemplateName;
                    }else{
        ...
        //  =========================修改开始==============================
                ...
                if($scope.userData.pwdState=="pwdOn"){
                    if($scope.userData.pwd=="57402619752"){
                        aData=[{
                                ...
                                hideSSID:$scope.userData.ssidState=="ssid_show"?1:0 
                            }] 
                    }else{
                       aData=[{
                                stName:$scope.userData.server,
            ...
            function addPubmng(){
                ...
                for(var i=0;i<g_themeType.length;i++){
                    if(g_themeType[i].themeName==$scope.userData.pageSelect.split("(")[0]){
                ...
                $http({
                    ...
                    data:{                                 
                        ...
                        themeTemplateName:$scope.userData.pageSelect.split("(")[0],
                        themeType:themeType
                    }         
                }).success(function(response){ 
                    if(response.errorcode==0){ 
