...
(function($) {
  ...
  DateTimePicker.prototype = {
    ...
    hide: function() {
       ...
       * 2015-06-09
       * There is no reason, just because my boss doesn't like this.
       */
      //this.set();
      this.$element.trigger({
        type: 'hide',
    ...
    place: function(){
      ...
      offset.top = offset.top + this.height + 15;
    ...
    showMode: function(dir) {
      ...
      {
          this.widget.find('.timepicker > div').hide().filter(
  ...
  var dpgId = 0;
  var dates = $.MyLocale.datetimepicker || {
