define(['angularAMD', 'utils', 'sprintf'],
    function (app, utils) {
        ...
        var URL_TEMPLATE_FILE = sprintf('../customer5/views/%s/xanth_come_rz.html', sLang);
        var conditionOnlineTimeUrl = '/stamonitor/getclientlistbycondition';
        var countUrl = '/stamonitor/gethistclientstatisticbyonlinetime';

        app.directive('xanthcomerz', ['$timeout', '$rootScope', '$http', '$q', '$state',
            function ($timeout, $rootScope, $http, $q, $state) {
                return {
                    ...
                    link: function ($scope, $element, $attrs, $ngModel) {                       
                        $http.get(conditionOnlineTimeUrl+'?devSN='+$scope.sn+'&reqType=onlinetime'+'&auth=1'               
                        ...
                        $http.get(countUrl+'?devSN='+$scope.sn+'&auth=1'+'&time=1'                           
                            ).success(function(data){
