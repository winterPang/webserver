define(['angularAMD', 'utils', 'sprintf'],
    function (app, utils) {
        ...
        var URL_TEMPLATE_FILE = sprintf('../customer5/views/%s/xanth_count_rz.html', sLang);
            ...
            function ($timeout, $rootScope, $http, $q) {
                return {
                    ...
                    link: function ($scope, $element, $attrs, $ngModel) {                       
                        $http.get(modeUrl+'?devSN='+$scope.sn+'&reqType=mode'+'&auth=1'                            
                        ...
                        $http.get(bybyodUrl+'?devSN='+$scope.sn+'&reqType=vendor'+'&auth=1'                          
                            ).success(function(data){
                                ...
                                terminalFirm.on(echarts.config.EVENT.CLICK, function(data){
                                    ...
                                    $scope.$broadcast('refresh#maoxian', {
                                        url: '/v3/stamonitor/getclientlist_bymodeorvendor?devSN='+$scope.sn+'&vendor='+apart+'&auth=1',
                                    });
                                    $scope.$broadcast("show#delog"); 
                                }); 
                                var terFirmOption = {
