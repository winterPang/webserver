define(["utils", 'bootstrap-daterangepicker','css!bootstrap_daterangepicker_css','css!warning/views/warning.css'], function (Utils) {
    return ['$scope', '$http', '$alertService', function ($scope, $http, $alert) {
        ...
        $scope.exportLog = function () {
            $scope.$broadcast('getData', function (data) {
                if(!data.length){
                    $alert.alert(getRcString("NOLOGEXPORT"), getRcString("NOTE_TITLE"));
                }else{
