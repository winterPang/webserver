define(["utils", 'bootstrap-daterangepicker', 'css!bootstrap_daterangepicker_css', 'css!alertlogs/views/warning.css'], function (Utils) {
    return ['$scope', '$http', '$alertService', '$state',function ($scope, $http, $alert,$state) {
        ...
        /* 2017.6.26 zhengchunyu 添加订阅按钮*/
        $scope.subscription = function()
        {
            $state.go("scene.content.monitor.noticesetting88");
        }
