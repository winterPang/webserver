...
cc.game = {
    ...
    _loadConfig: function () {
        ...
        if (document["ccConfig"]) {
            ...
            try {
                ...
                if(!txt){
                    txt = cc.loader._loadTxtSync("./libs/position/project.json"); //liuchao 这里导入 project.json 文件
                }
    ...
    _initRenderer: function (width, height) {
        ...
        cc._renderType = cc.game.RENDER_TYPE_CANVAS;//modified by liuchao 龙冠楼下的电脑不好用
        if (cc._renderType === cc.game.RENDER_TYPE_WEBGL) {
...
cc.Director = cc.Class.extend({
    ...
    setDisplayStats: function (displayStats) {
        displayStats = false;// modified by liuchao
        if (cc.profiler) {
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
    if (cc._renderType === cc.game.RENDER_TYPE_CANVAS) {
        ...
        cc.extend(cc.DrawNode.prototype, {
            ...
            drawWall: function (vertices, fillColor, lineWidth, lineColor){
