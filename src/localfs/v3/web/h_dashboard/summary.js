...
;(function ($) {
    ...
    var MODULE_NAME = "h_dashboard.summary";

    var g_aApp =
    {
        "SysLog":       {position: 0, bg: "",        url: "h_dashboard.Syslog"}
        ,"APs":         {position: 1, bg: "echart-height",  url: "h_dashboard.APs"}
        ,"health":      {position: 2, bg: "echart-height",  url: "h_dashboard.health"}
        ,"SSID":        {position: 1, bg: "",               url: "h_dashboard.ssid_test"}
        ,"Clients":     {position: 2, bg: "",               url: "h_dashboard.Clients"}
        ,"Usage":       {position: 3, bg: "echart-height", url: "h_dashboard.Usage"}
    };
