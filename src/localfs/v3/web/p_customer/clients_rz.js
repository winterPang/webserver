;(function ($){
    var MODULE_BASE = "p_customer",
        MODULE_NAME = MODULE_BASE+".clients_rz",
        g_jMList = null,
        g_jMListSP = null,
        g_jMListTJ = null;
    ...
    function getRcText (sRcId){
        return Utils.Base.getRcString ("clients_rz_rc", sRcId);
    }
    ...
    function initDLData(skipWhatData,meiYeShuJu,guoLvData,naGeList){
        ...
        var url=MyConfig.path+"/stamonitor/getclientverbose_page?devSN="+FrameInfo.ACSN +"&auth=1";
