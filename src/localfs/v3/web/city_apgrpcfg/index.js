(function ($)
{
    var MODULE_NAME = "h_wireless.index";
    var g_allData;
    var g_oTableData = {};
    var i=0;
    ...
    {
        var ssidName = $(this).attr("ssidName");
        var oData = g_oTableData[ssidName];
    ...
    function initData(){
        ...
        function getmaxReceiveRatio(obj){
         ...
         function getWireLessDataSuc(data){
            ...
            var aSECURITYIE = getRcText("SECURITYIE").split(',');//WPA,RSN,OSEN,Not configured"
            ...
            var aAKMMODE=getRcText("AKMMODE").split(',');
                if('{"errcode":"Invalid request"}' == data){
                   ...
                   for(var i =0;i<resfrsh.length;i++){
                    g_oTableData[resfrsh[i].ssidName]=resfrsh[i];
                }
                }
            }
