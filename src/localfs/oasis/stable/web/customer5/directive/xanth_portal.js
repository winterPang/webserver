define(['angularAMD', 'utils', 'sprintf'],
    function (app, utils) {
        ...
        var URL_TEMPLATE_FILE = sprintf('../customer5/views/%s/xanth_portal.html', sLang);
        var conditionApgroupUrl = '/stamonitor/getclientlistbycondition';
            ...
            function ($timeout, $rootScope, $http, $q) {
                return {
                    ...
                    link: function ($scope, $element, $attrs, $ngModel) {                       
                        $http.get(conditionApgroupUrl+'?devSN='+$scope.sn+'&reqType=group'				            
