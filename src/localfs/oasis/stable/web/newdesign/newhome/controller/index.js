 ...
 */
define(['utils','angular','jqueryZtree', 'echarts3', "css!newdesign/newhome/css/index", "css!newdesign/newhome/css/home", 'css!frame/libs/ztree/css/zTreeStyle'], function (Utils,angular,jqueryZtree,echarts) {
    return ['$scope', '$http', '$timeout','$rootScope','$state', function ($scope, $http, $timeout,$rootScope,$state) {
        ...
        $("#branch").css("background-color","#4188ce");
        $("#simple").css("background-color","#dddddd");
        ...
        $scope.activeTab1 = 1;
        $scope.changeTab1 = function (number) {
            $scope.activeTab1 = number;
        };
        ...
        $scope.groupTable = {
            ...
            columns: [
                ...
                {field: 'op', title: "操作",formatter:function () {
                    return "<a href='https://oasisrd.h3c.com/oasis/stable/web/frame/index.html#/newscene5/nasid352331/devsn219801A0WFH133000005/content/monitor/dashboard' target='_blank' class='tbtn'>运维</a><a href='https://oasisrd.h3c.com/oasis/stable/web/frame/index.html#/newdesign/content/system/devmanage' class='tbtn'>管理设备</a>"
                },width:200}
            ]
        };
        $scope.shopTable = {
            ...
            columns: [
                ...
                {field: 'op', title: "操作",formatter:function () {
                    return "<a href='https://oasisrd.h3c.com/oasis/stable/web/frame/index.html#/newdesign/content/system/devmanage' class='tbtn'>管理设备</a><a href='https://oasisrd.h3c.com/oasis/stable/web/frame/index.html#/newdesign/content/system/apBranchMng_demo' class='tbtn'>管理分组</a>"
                },width:200}
            ]
        };
