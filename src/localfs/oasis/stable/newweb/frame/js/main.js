require.config({
    ...
    paths: {
        ...
        "angular-messages": "frame/libs/angularjs/angular-messages.min",
        "angular-ui-router": "frame/libs/ui-router/angular-ui-router.min",
        "angularAMD": "frame/libs/angularjs/angularAMD",
        "bootstrap": "frame/libs/bootstrap/js/bootstrap.min",
        ...
        "moment": "frame/libs/bootstrap-daterangepicker/moment.min",
        ...
        //directive
        base_css: 'frame/css/base',
        header_css: 'frame/css/header',
        bootstrap_css: 'frame/libs/bootstrap/css/bootstrap.min',
        font_awesome: 'frame/libs/fontAwesome/css/font-awesome.min',
    ...
    map: {
        '*': {
            ...
            text: 'frame/libs/requirejs/text.min'
        }
    },
    deps: [
        //  启动加载的css文件
        ...
        'css!jqueryNotice_css', 'css!font_awesome', 'css!select2_css', 'css!base_css', 'css!header_css',
        //  启动加载的js文件
        //  I think 'jquery' must be loaded first,set angular.element === $.
        'jquery', 'app', 'baseService', 'bsTable', 'angular-messages', 'select2',
        'oasisModal', 'frame/directive/bs_pager', 'frame/directive/iconfont',
