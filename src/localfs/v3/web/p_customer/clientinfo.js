;(function($){
    var MODULE_NAME = "p_customer.clientinfo";
    ...
    function getOnlineData(skipWhatData,meiYeShuJu,guoLvData){
        ...
        $.extend(requestDataPost,guoLvData);
            ...
            var url=MyConfig.path+"/stamonitor/getclientlistbycondition?devSN=210235A1JNB161000011&reqType=onlineinfo"+authReqValueReceive;
