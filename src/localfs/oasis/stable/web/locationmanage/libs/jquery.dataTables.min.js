...
(function (h) {
    ...
    function pb(a) {
        var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures, g = '<input type="search"  class="' + b.sFilterInput + '"/><span class="glyphicon glyphicon-search form-control-feedback"></span>', j = d.sSearch, j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g, b = h("<div/>", {
