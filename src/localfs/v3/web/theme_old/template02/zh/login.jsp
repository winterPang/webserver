		      ...
		      <div class="item active">
		         <div id="image100"
					...
					style="position: relative;">
		         	<img class="canvas_img_replace"  src="images/logo-inverted.png" style="width: 100%;" />
		         </div>
		      </div>
		      <div class="item">
		         <div id="image101"
					class="adClass imageAd"
					style="position: relative;">
		         	<img class="canvas_img_replace" src="images/logo-inverted2.png"style="width: 100%;" />
		         </div>
		      </div>
		      <div class="item">
		         <div id="image102"
					class="adClass imageAd"
					style="position: relative;">
		         	<img class="canvas_img_replace" src="images/logo-inverted3.png" style="width: 100%;"/>
		         </div>
		      </div>
		   </div>
</div> 
    ...
    <div style="position: relative;overflow:hidden;" id="login">
        <div class="row" >
	        <div class="col-md-3 col-xs-3"><a href="javascript:void(0);" id="image103" >
	            <img class="canvas_img_replace  img-circle" style="width: 50px;height:50px; margin-left: 20px;margin-top: 10px;"  src="images/logoLogin.png"></a>
	        </div>
		...
		<div id="phoneDiv" style="margin-top:10px">
			<form
				...
				<div class="form-group">
                     <div class="col-xs-12" >
	                     <div class="line_02"  >
	                   		<span style = "position: relative ;top: -12px;font-size: 12px;background: #f9f9f9;padding: 0 5px;">  账号登录</span>
					...
					<div class="col-xs-4" style="padding-left: 0px;">
						<div class="">
							 <input id="loginBtn1" value="登录"
								class="canvas-edited-text btnLogin" style="width: 100%;height:30px;font-size:16px;color: white;padding-left: 1px;"
								type="button">
						</div>
					</div>
				</div>
			...
			<form
				...
				role="form" action="#" method="post" style="margin-top:15px">
				  <div class="form-group">
                       <div class="col-xs-12">
                         <div class="line_02">
                            <span style = "position: relative ;top: -12px;font-size: 12px;background: #f9f9f9;padding: 0 5px;"> 手机登录</span>
				...
				<div class="form-group">
					...
					<div class="col-xs-4" style="padding-left: 0px;">
						<input id="sendLoginMessageBtn2" value="获取验证码"
							style="width: 100%;height:30px;font-size:16px;color: white;" class="canvas-edited-text btnLogin"
							type="button">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-4" style="padding-left: 0px;">
						<input id="loginBtn2" value="登录"
							class="canvas-edited-text btnLogin" style="padding-left: 1px;width: 100%;height:30px;font-size:16px;color: white;"
							type="button">
					</div>
				</div>
			</form>
			...
			<div class="form-group">
				...
				<div class="col-xs-4" style="padding-left: 0px;">
					<input id="sendLoginMessageBtn4" value="获取验证码"
						style="width: 100%;height:30px; font-size:16px;" class="canvas-edited-text btnLogin"
						type="button">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-xs-4" style="padding-left: 0px;">
					<input id="loginBtn4" value="登录"
						class="canvas-edited-text btnLogin" style="width: 100%;height:30px;font-size:16px;color: white;"
						type="button">
				</div>
			</div>
		</form>
	...
	<div style="margin-top: 30px; margin-bottom: 0px; max-width: 100%;">
		<div class="bg-white"
			...
			<div class="social-buttons" style="margin: 15px 5px 5px 5px;">
				<div id="qqDiv"  style="display: inline-block; margin-right: 17px;">
					<div id="qq" >
				...
				<div id="weixinDiv" style="display: inline-block; margin-right: 17px;">
					<div id="weixin">
