 ...
 */
define(['bootstrap-table-CN', 'utils', 'bootstrapValidator', 'fullcalendar', 'css!frame/libs/fullcalendar-3.0.1/css/fullcalendar','filesystem/libs/oasis-select',
    'css!configrestore/css/style'], function ($, Utils) {
