(function($) {
    var MODULE_BASE = "city_wireless";
    var MODULE_NAME = MODULE_BASE + ".index_wireless";
    var MODULE_RC = "h_wireless_indexConfigure";
    ...
    function initForm() {
        ...
        function showSSID(oRowdata, sName) {
            $("#apName").text(oRowdata.sp_name);
            $("#SSID").text(oRowdata.ssid_name);
            $("#serviceStatus").text(oRowdata.status);
            $("#cipherSuite span").text("否");
            $("#loginView").text("简约");

            //if (oRowdata.status == "开启") {
        ...
        var serviceData = [
            {
                "sp_name": "test1",
                "ssid_name": "smartCity111",
                "serviceType": "城市热点",
                "status": "开启",
                "bindAPGroup": "2"
            }, {
                "sp_name": "test2",
                "ssid_name": "smartCity222",
                "serviceType": "城市设备",
                "status": "开启",
                "bindAPGroup": "2"
            },{
                "sp_name": "test3",
                "ssid_name": "smartCity333",
                "serviceType": "内部服务",
                "status": "关闭",
                "bindAPGroup": "2"
            }
        ...
        refreshSSIDList(serviceData);
        //$("#onlineuser_list").Slist("refresh", serviceData);
        $("#onlineuser_list").on('click', 'a.list-link', onDisDetailAPGroup);
        ...
        var oSListAPGroup = {
            ...
            buttons: [{
                ...
                //action: function(){
                //            return function() {
                //                Frame.Msg.confirm("确定要绑定该AP组吗？", function () {
                //                    return;
                //                })
                //            }
                //         }(),
        ...
        $("div[title='已绑定']").attr("style", "color:#4ec1b2");
    }
