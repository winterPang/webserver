    ...
    return ['$scope', '$rootScope', '$alertService', function ($scope, $rootScope, $alert) {
        ...
        $scope.upgradeList = {
            ...
            columns: [
                ...
                {field: 'uptime', showTooltip: true, title: '上次升级时间'},
                {field: 'upresult', showTooltip: true, title: '上次升级结果'},
                {
                    field: 'upstatus', showTooltip: true, title: '当前升级状态', formatter: function (val, row) {
                    return $scope.flags.ing ? '<i class="fa fa-upload"></i>' : val;
                }
                }
            ]
        };
